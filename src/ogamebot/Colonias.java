...
public class Colonias {
    ...
    private final String SHIPS_TO_SEND;
        ...
        public Colonias(WebClient webClient, ReadProperties properties, String cp) throws IOException{
    ...
    public void enviarRecursos() throws IOException {
        try {
            ...
            System.out.println(Utils.getHour() + " - Recursos enviados al planeta principal desde la colonia");
