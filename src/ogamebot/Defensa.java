...
public class Defensa {
    ...
    public void buildLanzamisiles() throws IOException {
        ...
        try {
            ...
            System.out.println(Utils.getHour() + " - Mi emperador, no ha sido posible la construcción de lanzamisiles. " + ex);
        }
    }
    ...
    public void buildSmallLaser() throws IOException {
        ...
        try {
            ...
            System.out.println(Utils.getHour() + " - Mi emperador, no ha sido posible la construcción de lásers pequeños. " + ex);
        }
    }
    ...
    public void buildGauss() throws IOException {
        ...
        try {
            ...
            System.out.println(Utils.getHour() + " - Mi emperador, no ha sido posible la construcción de cañones gauss. " + ex);
        }
    }
    ...
    public void buildIonico() throws IOException {
        ...
        try {
            ...
            System.out.println(Utils.getHour() + " - Mi emperador, no ha sido posible la construcción de iónicos. " + ex);
        }
    }
